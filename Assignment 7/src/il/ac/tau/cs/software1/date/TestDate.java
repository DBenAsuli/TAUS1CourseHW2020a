...
public class TestDate {
	...
	public static void main(String[] args) {
		...
		int d2 = 390;
		int[] d3 = {1986, 9, 24};
		String d4 = "24/9/1986"; //==date3
		int[] d5 = {2019, 11, 12}; // ==date=1
...
//		System.out.println(date1.toString());
		...
		date4.addDays(12084);
		System.out.println("date4 (=date3) after adding 12084 days: " + date4); // 2/11/2019
		
		date1.addDays(-12084);
		System.out.println("date1 after subtracting 12084 days: " + date1); // 24/9/1986
		
		date5.addDays(-12084);
		System.out.println("date5 (==date1) after subtracting 12084 days: " + date1); // 24/9/1986
	}
